...
Em seguida, você desejará [instalar ferramentas adicionais do Azure](./azure-tools.md) como Gerenciador de Armazenamento do Azure e Azure Data Studio para torná-lo mais produtivo com o Azure.

...
- (13) **Microsoft. NetCore. app. host. \<rid>** contém um binário nativo para plataforma `rid` . Esse binário é um modelo ao compilar um aplicativo .NET em um binário nativo para essa plataforma.

---
description: 'Saiba mais sobre: <reliableSession>'
...
ms.locfileid: "99683405"
---
# \<reliableSession>

Define a configuração para WS-Reliable mensagens. Quando esse elemento é adicionado a uma associação personalizada, o canal resultante pode dar suporte a garantias de entrega exatamente uma vez.  
...
|flowControlEnabled|Um valor booliano que indica se o controle de fluxo avançado, uma implementação específica da Microsoft de controle de fluxo para WS-Reliable mensagens, está ativado. O padrão é `true`.|  

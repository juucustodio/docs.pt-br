---
description: 'Saiba mais sobre: <remove>'
title: <remove>
ms.date: 03/30/2017
...
|Atributo|Descrição|  
|---------------|-----------------|  
|type|O nome do tipo CLR do manipulador de token a ser removido. Para obter mais informações sobre como especificar o `type` atributo, consulte [referências de tipo personalizado](/previous-versions/windows-identity-foundation/gg638728(v=msdn.10)#custom-type-references). Obrigatório.|  

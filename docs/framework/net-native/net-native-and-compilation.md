---
description: 'Saiba mais sobre: .NET Native e compilação'
...
- [Metadados e componentes de Self-Describing](../../standard/metadata-and-self-describing-components.md)

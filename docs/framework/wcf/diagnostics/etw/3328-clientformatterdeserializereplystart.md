---
description: 'Saiba mais sobre: 3328-ClientFormatterDeserializeReplyStart'
...
## <a name="description"></a>Descrição  
 ...
 Esse evento é emitido quando o cliente inicia a desserialização da mensagem de resposta.  

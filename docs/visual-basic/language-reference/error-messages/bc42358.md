---
description: 'Saiba mais sobre: BC42358: como essa chamada não está aguardada, a execução do método atual continua antes que a chamada seja concluída'

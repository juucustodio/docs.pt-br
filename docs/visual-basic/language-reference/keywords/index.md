---
description: 'Saiba mais sobre: palavras-chave (Visual Basic)'
...
|[`CInt`](../functions/type-conversion-functions.md)|[`Class` Constraint](../statements/type-list.md)|[`Class` Privacidade](../statements/class-statement.md)|[`CLng`](../functions/type-conversion-functions.md)|
...
|[`Each`](../statements/for-each-next-statement.md)|[`Else`](../statements/else-statement.md)|[`ElseIf`](../statements/if-then-else-statement.md)|[`End` Privacidade](../statements/end-statement.md)|
...
|[`If`](../statements/if-then-else-statement.md)|[`If()`](../operators/if-operator.md)|[`Implements`](../statements/implements-clause.md)|[`Implements` Privacidade](../statements/implements-statement.md)|
|[`Imports` (Namespace e tipo do .NET)](../statements/imports-statement-net-namespace-and-type.md)|[`Imports` (Namespace XML)](../statements/imports-statement-xml-namespace.md)|[`In`](../statements/in-clause.md)|[`In` (Modificador genérico)](../modifiers/in-generic-modifier.md)|
...
|[`Module`](../modifiers/module-keyword.md)|[`Module` Privacidade](../statements/module-statement.md)|[`MustInherit`](../modifiers/mustinherit.md)|[`MustOverride`](../modifiers/mustoverride.md)|
...
|[`Narrowing`](../modifiers/narrowing.md)|[`New` Constraint](../statements/type-list.md)|[`New` Operador](../operators/new-operator.md)|[`Next`](../statements/for-next-statement.md)|
|[`Next` (em `Resume` )](../statements/resume-statement.md)|[`Not`](../operators/not-operator.md)|[`Nothing`](../nothing.md)|[`NotInheritable`](../modifiers/notinheritable.md)|
...
|[`String`](../data-types/string-data-type.md)|[`Structure` Constraint](../statements/type-list.md)|[`Structure` Privacidade](../statements/structure-statement.md)|[`Sub`](../statements/sub-statement.md)|

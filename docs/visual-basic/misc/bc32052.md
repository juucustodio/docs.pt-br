---
description: "Saiba mais sobre: o operando ' is ' do tipo ' <typeparametername> ' só pode ser comparado a ' Nothing ' porque ' <typeparametername> ' é um parâmetro de tipo sem restrição de classe"

---
description: "Saiba mais sobre: o membro ' <membername1> ' está em conflito com um membro implicitamente declarado para o membro ' <membername2> ' no tipo base ' <basetypename> ' e, por isso, não deve ser declarado como ' sobrecargas '"
